...
class LessonForm(forms.ModelForm):
	...
	payment_type = forms.ChoiceField(label="支付总额", widget=forms.TextInput(attrs={'class':'form-control mb-4 p-2 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-blue-300', 'placeholder': '支付总额'}))
